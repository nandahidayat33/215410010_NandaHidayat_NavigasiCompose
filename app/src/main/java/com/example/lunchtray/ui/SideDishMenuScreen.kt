...
@Composable
fun SideDishMenuScreen( /*pada halaman ini, hampir sama seperti pada
                        halaman EntreeMenuScreen.kt, pada halam ini
                        terdapat function SideDishMenuScreen, yang juga
                        menampilkan option item-item menu side dish
                        ...
                        selanjutnya beralih ke halaman
